...
<body>
    ...
    <div id="main-app">
        ...
        <div class="top-nav desktop-only">
            ...
            <div class="desktop-menu">
                <button id="dt-nav-market" class="active" onclick="switchPage('market')">食材</button>
    ...
    <script>
        ...
        const allRecipes = [
            ...
            {
                id: "Hidden1", name: "奶油酪梨雞胸肉佐蒜香地瓜葉", cal: 450, img: "奶油酪梨雞胸肉佐蒜香地瓜葉.jpg", hidden: true,
